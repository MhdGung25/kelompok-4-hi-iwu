...
function ViewGaleri() {
  ...
  const kontenBudaya = {
    ...
    mongolia: {
      ...
      videoUrl: "https://www.youtube.com/embed/EOpUZ9uAKz0",
      culturalPerspective:
 ...
 {/* 1. HERO SECTION */}
<section className="relative w-full h-[65vh] md:h-[80vh] overflow-hidden bg-white pt-4">
  <img
    src={data.mainImage}
    alt={data.country}
  ...
  {/* 
    PERUBAHAN UTAMA: 
    Menghapus kelas 'mt-4' pada div ini agar posisi teks kembali presisi 
    di tengah-tengah gambar secara vertikal (atas-bawah) dan horizontal (kanan-kiri).
  */}
  <div className="absolute inset-0 flex items-center justify-center p-6">
    <h1 className="text-6xl md:text-[10rem] font-black text-white uppercase tracking-tighter leading-none [text-shadow:_0_4px_24px_rgba(0,0,0,0.6)] select-none">
      {data.country}
    </h1>
  </div>
</section>
