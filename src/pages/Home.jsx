...
function Home() {
  ...
  return (
    /* 
      PERUBAHAN UTAMA:
      1. Menambahkan `pt-4` agar seluruh kontainer gambar & teks dipaksa turun ke bawah 
         dan memberikan jarak aman dari navbar atas.
      2. Menambahkan `bg-white` agar celah jarak kosong di atas gambar berwarna putih bersih 
         dan menyatu rapi dengan navbar.
    */
    <main 
      className="flex-grow flex items-center justify-center px-6 py-24 md:py-20 bg-cover bg-center bg-no-repeat relative min-h-[80vh] bg-white pt-4"
    ...
    >
      ...
      {/* Konten Utama (Tetap terkunci presisi di tengah-tengah gambar) */}
